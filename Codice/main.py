...
def main():
    ...
    df1.name = 'DisturbiMentali-DalysNazioniDelMondo'  # Aggiungi l'attributo name
    df2 = data_handling.read_data(r'dbUsati\DisturbiMentali2008-areeGeografiche.csv')
    df2.name = 'DisturbiMentali2008-areeGeografiche'  # Aggiungi l'attributo name
    df3 = data_handling.read_data(r'dbUsati\6- depressive-symptoms-across-us-population.csv')
    df3.name = 'Depressive-symptoms-across-us-population'  # Aggiungi l'attributo name
    ...
    df4.name = 'Number-of-countries-with-primary-data'  # Aggiungi l'attributo name
